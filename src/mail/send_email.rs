...
impl EmailClient {
    pub fn new(email_settings: EmailClientSettings, sender: SubscriberEmail) -> Self {
        Self {
...
mod tests {
    ...
    fn email_client(server_uri: String) -> EmailClient {
        ...
        let sender = SubscriberEmail::parse(email_settings.sender_email.clone()).unwrap();
