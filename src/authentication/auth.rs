...
pub async fn validate_credentials(
    ...
    // to avoid attackers figure how a user exists or not, we create a fake hash we force
    // to ensure the same amount of work is done regardless of if they exists or not.
